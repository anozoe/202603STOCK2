...
@Data
@Entity
@Table(name = "assets_total_history")
public class AssetsTotalHistory {
    ...
    @Column(name = "buying_power", precision = 10, scale = 2)
    ...
    @Column(name = "friday_judge", nullable = false)
    private Integer fridayJudge;
